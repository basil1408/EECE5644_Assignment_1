...
[A,num] = cholcov(a);
%{
Covariance matrix entered needs to be square, symmetric, and positive 
semi-definite otherwise cholcov()function will return a null vector or a 
NaN and the product y=A*z will show error as the dimensions will not match 
